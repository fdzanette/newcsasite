...
(function () {
  ...
  var EN = {
    ...
    /* --- College Placement --- */
    'col-intro': '<strong>College Sports Authority</strong> is a consultancy dedicated to guiding student-athletes through the U.S. university admissions process. We stay by their side throughout their college careers, providing support every step of the way and opening doors to personal and professional growth.',
    'col-caminho-h': 'Your path to college <i class="fa-solid fa-arrow-trend-up"></i>',
    'col-caminho-p': 'We help students sharpen both their skills and the way they present themselves, so they stand out as the strongest possible candidates for the universities they target — and give themselves the best shot at admission. We guide every step of the application: mapping requirements and deadlines, planning document submissions, and reviewing and sending each application package. And we stay involved through all four years of college, offering day-to-day guidance and helping with the cultural adjustment.',
    ...
    'col-orientacao-p': '<u>Preparing the athlete</u> to be introduced to the coaches at the selected universities in the best possible light.',
    ...
    'hs-caminho-p': 'Attending an American high school is the first step of an academic and athletic journey in the United States. For student-athletes aged 14 to 17, in any sport, it’s a chance to grow in the classroom, develop in their sport, and experience American culture early on — building a strong profile from the start that can open the door to future university opportunities.',
    'hs-avaliacao-h': 'Assessment <i class="fa-solid fa-clipboard-check"></i>',
    'hs-avaliacao-p': '<u>An academic, athletic, and family assessment</u> to understand where the student stands, what they’re aiming for, and the family’s context — before we recommend anything.',
